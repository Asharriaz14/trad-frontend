export default function ResponsiveLayout() {
  ...
  const headingText = (
    <>
      The Worlds {""}
      <span className="text-6xl lg:text-8xl font-semibold ">
        Number One Broker
      </span>
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-[60%] w-full flex flex-col items-center md:items-start gap-4 mb-8 lg:mb-0 text-white">
            ...
            <div className="w-full lg:w-[36rem] sm:text-center text-left">
              <p className="text-4xl font-medium w-full left-center">
                {headingText}
              </p>
            </div>
          </div>
          ...
          <div className="lg:w-[40%] w-full flex flex-col gap-8 items-center justify-center text-white">
            ...
            <button className="px-8 py-3 text-lg font-medium bg-blue-600 text-white rounded-full hover:bg-blue-700 transition">
              Trade Like A Pro!
            </button>
          </div>
        </div>
