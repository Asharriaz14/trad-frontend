  ...
  return (
    <>
      <div className="max-w-screen-xl mx-auto px-4 py-4 sm:px-6 lg:py-12 lg:px-8">
        <div className="px-6 py-6 rounded-lg  bg-blue-700">
              ...
              <div id="mc_embed_signup">
                <form className="sm:flex w-full">
                  <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0 w-full">
                    <Link
                      className="w-full flex items-center justify-center px-16 py-3 text-base leading-6 font-medium rounded-full text-blue-600 bg-white focus:ring hover:bg-indigo-700 focus:outline-none focus:bg-indigo-400 transition duration-150 ease-in-out"
                      to="/register"
                    >
                      Trade like a Pro
                    </Link>
